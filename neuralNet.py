...
def run(
        weights='modelData/mnist_nano_v3.pt',  # model.pt path(s)
        source='modelData/input',  # file/dir/URL/glob, 0 for webcam
        data='modelData/mnist.yaml',  # dataset.yaml path
        ...
        project='modelData/output',  # save results to project/name
...
@smart_inference_mode()
def runAlpha(  # model.pt path(s)
        source='iebc_forms/imgcrops',  # file/dir/URL/glob, 0 for webcam
          # dataset.yaml path
        imgsz=(640, 640),  # inference size (height, width)
        conf_thres=0.25,  # confidence threshold
        iou_thres=0.45,  # NMS IOU threshold
